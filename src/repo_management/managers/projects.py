...
def query_project(
    ...
    if project is None:
        msg = (
            ...
            "owner_type and that the token has Projects access (a user-owned board needs a "
            "classic PAT with the 'project' scope; a fine-grained PAT's Projects permission "
            "covers org-owned boards only)"
        )
